...
const Hero = React.memo(() => {
  return (
    ...
    >
      ...
      <aside className="mt-12 mb-8 inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full border border-gray-700 bg-gray-800/50 backdrop-blur-sm max-w-full">
        <span className="text-xs text-center whitespace-nowrap" style={{ color: '#9ca3af' }}>
          Plataformas Escalables y 100% Seguras
        </span>
      </aside>
      ...
      >
        Sistemas de Gestión y <br />Dashboards a Medida
      </h1>

      <p className="text-sm md:text-base text-center max-w-2xl px-6 mb-10" style={{ color: '#9ca3af' }}>
        Toma el control absoluto de tu negocio con paneles personalizados: gestiona finanzas, clientes, ventas, ingresos, egresos y métricas clave en un solo lugar.
      </p>
...
export default function TemplateHero() {
  return (
    <main className="template-hero-section relative min-h-screen bg-black text-white overflow-hidden border-y border-white/10">
      <Hero />
    </main>
  );
}
