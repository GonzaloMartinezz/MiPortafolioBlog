...
function StepperIndicator({ children, className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'relative flex items-center overflow-hidden justify-center size-8 shrink-0 border-background bg-accent text-accent-foreground rounded-full text-xs data-[state=completed]:bg-primary data-[state=completed]:text-primary-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all duration-300 font-bold',
        className,
      )}
    >
...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'm-0.5 rounded-full bg-muted group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1 data-[state=completed]:bg-primary transition-all duration-300',
        className,
      )}
    />
  );
...
function StepperTitle({ children, className }: React.ComponentProps<'h3'>) {
  ...
  return (
    <h3 data-slot="stepper-title" data-state={state} className={cn('text-sm font-semibold leading-none', className)}>
      {children}
    </h3>
  );
}
...
function StepperDescription({ children, className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div data-slot="stepper-description" data-state={state} className={cn('text-xs text-muted-foreground', className)}>
      {children}
    </div>
  );
}
...
function StepperNav({ children, className }: React.ComponentProps<'nav'>) {
  ...
  return (
    <nav
      ...
      data-orientation={orientation}
      className={cn(
        'group/stepper-nav inline-flex data-[orientation=horizontal]:w-full data-[orientation=horizontal]:flex-row data-[orientation=vertical]:flex-col items-center gap-1.5',
        className,
      )}
    >
      {children}
