    ...
    <nav className="w-full flex flex-col md:flex-row items-center justify-between py-6 md:py-8 animate-fade-in-up">
      ...
      <div className="mb-6 md:mb-0 text-center md:text-left w-full md:w-auto">
        <Link href="/" className="block group">
            ...
            Gonzalo <br className="hidden md:block"/> <span className="md:hidden"> </span> Martínez
            </h2>
        </Link>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-3 md:gap-10 items-center bg-gray-600/40 backdrop-blur-md px-5 py-3 md:px-8 rounded-full border border-slate-200/60 shadow-sm mb-6 md:mb-0 max-w-full">
        <Link href="/" className={linkStyles("/")}>Home</Link>
        <Link href="/who" className={linkStyles("/who")}>Quién soy?</Link> {/* Texto acortado para móvil */}
        <Link href="/blog" className={linkStyles("/blog")}>My Blog`s</Link>
